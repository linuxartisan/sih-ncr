...
@section('breadcrumbs')
    ...
    <li class="breadcrumb-item"><a href="{{ action('CompanyController@index') }}">Company</a></li>
...
<div class="row">
    <div class="col-lg-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>Company <small>Edit</small></h2>
...
<div class="row">
    <div class="col-lg-6">
        <div class="x_panel">
            <div class="x_title">
                <h2>Company <small>Delete</small></h2>
            <div class="clearfix"></div>
            </div>
            <div class="x_content">
                <div class="note">
                ...
                {!! Form::open(['action' => ['CompanyController@destroy', $company->id],
                                'method' => 'delete',
...
@section('page_script')
    ...
    @include('company._form_script')

    <script type="text/javascript">
        function show_alert () {
            return confirm('Delete this Company?');
        }
    </script>
