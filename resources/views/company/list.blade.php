  ...
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
        ...
        <div class="row">
          ...
          <div class="col-xs-4">
            <div class="pull-right">
              <a href="{{ action('CompanyController@create') }}" type="button" class="btn btn-primary">
      ...
      <div class="x_content">
        ...
        <table id="dt_company_list" class="table table-bordered" style="width: 100%;">
          <thead>
            <tr>
...
@section('page_script')
  ...
  <script type="text/javascript">
    $(document).ready(function() {
      var table = $('#dt_company_list').DataTable({
        "order": [[0, 'asc']],
        "responsive": true,
        "columnDefs": [
          {
          ...
          { "className": 'none', "targets": [1, 2] }, // don't display as column, show in child row
        ],
      });
